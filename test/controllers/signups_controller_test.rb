...
class SignupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create signup" do
    assert_difference('Signup.count') do
      post signups_url, params: { signup: { email: @signup.email, name: @signup.name, password_digest: @signup.password_digest } }
    end
  ...
  test "should update signup" do
    patch signup_url(@signup), params: { signup: { email: @signup.email, name: @signup.name, password_digest: @signup.password_digest } }
